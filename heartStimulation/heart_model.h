...
void heart_model(node_def *node_table ,int size_node_table, path_def *path_table,int size_path_table){

node_def temp_node[size_node_table];
path_def temp_path[size_path_table];
path_def temp_path_node[size_path_table];
